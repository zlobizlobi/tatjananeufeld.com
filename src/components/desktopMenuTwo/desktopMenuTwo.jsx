...
export const Nav = styled.nav`
    width: 100%;
    background-color: ${({ isScrolled }) => isScrolled ? '#0d0d0d' : 'transparent'};
...
export const NavLink = styled(NavLinkComponent)`
    ...
    ${({ isActive }) => isActive && css`color: white;
    `}
...
export const DesktopMenuTwo = () => {
    ...
    const navLinks = ['home', 'concerts', 'biography', 'gallery', 'Tatjana Neufeld', 'repertoir', 'partners', 'teacher', 'contact'];
