            ...
            <ItemContainer>
                {mapObject[activeItems].map(item => {
                    ...
                    if (item.slice_type === 'image_plakat') {
                        const fluid = item.primary.plakat_image.localFile && item.primary.plakat_image.localFile.childImageSharp.fluid
                        const src = fluid && item.primary.plakat_image.localFile.childImageSharp.fluid.src
                        return (
                            <Link
                                href={src || thumbnail}
                                target="_blank"
                                ...
                                rel="noopener"
                            >
                                {fluid ? <ImageFluid fluid={fluid} /> : <Image src={thumbnail} />}
                            </Link>
                        )
                    }
                    ...
                    if (item.slice_type === 'kritik') {
                        ...
                        const fluid = base.critique_image.localFile.childImageSharp.fluid
