...
import { Text, Section, FirstImage, NameHighlight,ContentContainer } from './styles';
...
export const BiographySection = () => (
  <Section name="biography">
    ...
    <Text>
      <NameHighlight style={{fontWeight: 900}}>Tatjana Neufeld</NameHighlight> ist erste Preisträgerin des Internationalen Klavierwettbewerbs 
